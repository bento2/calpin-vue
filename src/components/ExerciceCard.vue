...
<template>
  <v-card color="blue-accent-2" outline class="d-flex flex-row justify-space-between">
    <div class="d-flex align-center font-bold ga-1 w-100 ">
      <ExerciceIcon :exercice="exercice" class="ml-1" />
